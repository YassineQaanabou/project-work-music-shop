...
INSERT INTO strumento (tipologia_id, nome, url_foto, descrizione, prezzo, slug) VALUES (1, 'Medeli Grand 510 BK Pianoforte', 'https://m.media-amazon.com/images/I/51b7QNffLAL._AC_SL1200_.jpg', 'Pianoforte Digitale a Coda', 3049.00, 'medeli-grand-510-bk');
...
INSERT INTO strumento (tipologia_id, nome, url_foto, descrizione, prezzo, slug) VALUES (2, 'Gibson Hummingbird Studio', 'https://m.media-amazon.com/images/I/71aadZCyTfL._AC_SL1500_.jpg', 'Chitarra acustica', 3451.53, 'gibson-hummingbird-studio-rw-natural');
INSERT INTO strumento (tipologia_id, nome, url_foto, descrizione, prezzo, slug) VALUES (2, 'Cordoba 55 FCE Ziricote', 'https://m.media-amazon.com/images/I/61Ii0s697SL._AC_SL1500_.jpg', 'Chitarra classica', 1689.99, 'cordoba-55-fce-negra-ziricote');
INSERT INTO strumento (tipologia_id, nome, url_foto, descrizione, prezzo, slug) VALUES (3, 'Btuty Sassofono C40BLII', 'https://m.media-amazon.com/images/I/61zRYliCb2L._AC_SL1500_.jpg', 'Sassofono contralto in ottone lucido inciso Eb E-Flat Natural White Shell Button Strumento a fiato con custodia Guanti muto Panno di pulizia Spazzola per cintura', 280.99, 'btuty-sassofono');
